...
public class LocalTicketGrantingTicketManager implements ITicketGrantingTicketService, ExpirationPolicy {
	...
	private class DummyTgt {
		...
		public DummyTgt(SsoUserResponse user, long expired) {
			super();
			this.user = user;
