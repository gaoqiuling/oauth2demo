...
import com.demo.smart.client.enums.GrantTypeEnum;
...
public class Oauth2Utils {
	 ...
	 * @return
	 */
	public static Result<AccessTokenResponse> getAccessToken(String serverUrl, String appId, String appSecret, String username,
															 String password) {
	 ...
	 * @return
	 */
	public static Result<AccessTokenResponse> getAccessToken(String serverUrl, String appId, String appSecret, String code) {
		Map<String, String> paramMap = new HashMap<>();
	 ...
	 * @return
	 */
	public static Result<AccessTokenResponse> refreshToken(String serverUrl, String appId, String refreshToken) {
		Map<String, String> paramMap = new HashMap<>();
		paramMap.put(Oauth2Constant.APP_ID, appId);
	...
	private static Result<AccessTokenResponse> getHttpAccessToken(String url, Map<String, String> paramMap) {
		String jsonStr = HttpUtils.get(url, paramMap);
		if (jsonStr == null || jsonStr.isEmpty()) {
			logger.error("getHttpAccessToken exception, return null. url:{}", url);
			return null;
		}
		return JSONObject.parseObject(jsonStr, new TypeReference<Result<AccessTokenResponse>>(){});
	}
}